...
<html lang="ko">
    ...
    <style>
            ...
            #locations{
                ...
                box-shadow: 5px 5px 15px #50b498; 
                border-radius: 30px; 
                width:1150px; 
                height:250px;
                overflow:auto;
            ...
            <body>
                ...
                <form id="locationForm" action="spotcatcher.php" method="post" style="display:grid; border: 3px solid #50b498; width: 1500px; height: 450px; margin-bottom:30px; overflow: auto;">
              
                    <div class="keyWorld" style="margin-top:10px;">
                    <p>키워드 입력</p>
                    <input type="text" name="keyword" id="KeyWords" placeholder = "키워드를 입력하세요." style="height:40px; width : 1150px; border:solid; border-color: #50b498;">
                    </div>
                    <div id="locations" style="flex-direction: column; box-shadow: 5px 5px 15px #50b498; border-radius: 30px; width:1150px; overflow:auto;">
                        <div class="location">
                            <p>위치 1 입력</p>
                            <input type="text" onclick="daumPostcode(1)" id="loc1" name="location[]" placeholder = "사용자의 위치를 입력하세요.">
                            <button type="button" class="removeLocationBtn">삭제</button>
                        </div>
                        <div class="location">
                            <p>위치 2 입력</p>
                            <input type="text" onclick="daumPostcode(2)" id="loc2" name="location[]" placeholder = "사용자의 위치를 입력하세요.">
                            <button type="button" class="removeLocationBtn">삭제</button>
                        </div>
                    </div>
                    <button type="button" id="addLocationBtn" style="height: 40px; margin-bottom:10px; background-color :#50b498; border : none;">위치 추가</button>
                    <button type="submit" style="height: 40px;  margin-bottom:10px; background-color :#50b498; border : none; ">제출</button>
                </form>
                <div id="map" style="width:100%;height:350px; margin-bottom:35px;"></div>
            </body>
