    ...
    <style>
        #locations .location input{
            ...
            <body>
                ...
                <form id="locationForm" action="spotcatcher.php" method="post" style="display:grid; border: 3px solid #50b498; width: 1500px; height: 150%; margin-bottom:30px;">
                    <div class="keyWorld" style="margin-top:10px;">
                        <p>키워드 입력</p>
                        <input type="text" name="keyword" id="KeyWords" placeholder = "키워드를 입력하세요." style="height:40px; width : 250px; border: 3px solid #50b498;">
                        
                    </div>
                    <div id="locations" style="flex-direction: column; box-shadow: 5px 5px 15px #50b498; border-radius: 30px; width:1150px; height:600px; overflow:auto; margin:5px;">
                        <div class="location">
                            <p>위치 1 입력</p>
