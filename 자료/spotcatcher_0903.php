...
<html lang="ko">
        ...
        <link href="https://fonts.googleapis.com/css2?family=Black+Han+Sans&family=Gothic+A1:wght@100;200;300;400;500;600;700;800;900&display=swap" rel="stylesheet">
            ...
            <body>
                ...
                <div class="introduce">
                    ...
                    <div class="Intro_explain_2">
                    <h4> Spot Catcher로<br>
                        약속 장소를 정해 보세요</h4>
                        <form id="goDown">
                            <button type="button"><img src="arrow_down.png" style="border:none;"></button>
                        </form>
                    </div>
                </div>
                <?php
    ...
    ?>
            <body>
                ...
                <form id="locationForm" action="spotcatcher.php" method="post" style="justify-content: center;">
                    <div class="keyWorld" style="margin-top:10px;">
                        <p>키워드 입력</p>
                        <input type="text" name="keyword" id="KeyWords" placeholder = "키워드를 입력하세요." style="height:40px; width : 250px;">
                        
                    </div>
                    <div id="locations" style="flex-direction: column; box-shadow: 5px 5px 15px #50b498; border-radius: 30px; width:1150px; height:350px; overflow:auto;">
                        <div class="location">
                            <p>위치 1 입력</p>
                            <input type="text" onclick="daumPostcode(1)" id="loc1" name="location[]" placeholder = "사용자의 위치를 입력하세요." style ="width:1000px; height:40px; border:solid; border-color:#50b498; margin-right: 10px">
                            <button type="button" class="removeLocationBtn">삭제</button>
                        </div>
                        <div class="location">
                            <p>위치 2 입력</p>
                            <input type="text" onclick="daumPostcode(2)" id="loc2" name="location[]" placeholder = "사용자의 위치를 입력하세요." style ="width:1000px; height:40px; border:solid; border-color:#50b498;">
                            <button type="button" class="removeLocationBtn">삭제</button>
                        </div>
                    </div>
                    <button type="button" id="addLocationBtn" style="margin-bottom:35px;">위치 추가</button>
